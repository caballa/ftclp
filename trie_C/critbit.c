...
/* Return 1 if the prefix does not match. Otherwise it returns 0 and
			  ...
			  int (*callback)(const char *, void *), void *baton)
{
	...
	/* Added by J.Navas. If the prefix does not match the code was
	   still calling cbt_traverse_prefixed */
	size_t i;
	for(i= 0;i<ulen;++i){
