/* -*- C -*-
 * 
 * MathSAT5 is copyrighted 2009-2014 by Fondazione Bruno Kessler, Trento, Italy,
 * University of Trento, Italy, and others. All rights reserved.
 * 
 * MathSAT5 is available for research and evaluation purposes in an academic
 * environment only. It can not be used in a commercial environment,
 * particularly as part of a commercial product, without written permission.
 * MathSAT5 is provided as is, without any warranty.
 * 
